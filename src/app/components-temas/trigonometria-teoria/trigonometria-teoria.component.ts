...
@Component({
  selector: 'app-trigonometria-teoria',
  templateUrl: './trigonometria-teoria.component.html',
  styleUrls: ['./trigonometria-teoria.component.css']
})
export class TrigonometriaTeoriaComponent {
// En tu componente
